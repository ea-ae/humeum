...
public partial class Init : Migration {
    ...
    protected override void Up(MigrationBuilder migrationBuilder) {
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                { 1, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(3024), null, "Regular flat income tax in Estonia, applicable to all income by default. First 654EUR/mo aka 7848EUR/yr are tax-free.", new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(3024), "Income tax", 20m, 7848, null, null, 20m },
                { 2, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(3027), null, "Asset income invested through III pillar, with an account opened in 2021 or later. Term pensions based on life expectancy, not included here, provide a 20% discount.", new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(3027), "III pillar, post-2021", 20m, 6000, 15m, 60, 10m },
                { 3, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(3028), null, "Asset income invested through III pillar, with an account opened before 2021. Term pensions based on life expectancy, not included here, provide a 20% discount.", new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(3029), "III pillar, pre-2021", 20m, 6000, 15m, 55, 10m }
            });

        migrationBuilder.InsertData(
            table: "TaxSchemes",
            columns: new[] { "Id", "CreatedAt", "DeletedAt", "Description", "ModifiedAt", "Name", "TaxRate" },
            values: new object[] { 4, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(3030), null, "Income that due to special circumstances (e.g. charity) is not taxed whatsoever.", new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(3030), "Non-taxable income", 0m });
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                { 1, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1702), null, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1707), "General", null },
                { 2, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1709), null, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1709), "Investing", null },
                { 3, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1710), null, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1710), "Work, Education, & Business", null },
                { 4, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1711), null, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1711), "Recreation & Lifestyle", null },
                { 5, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1713), null, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1713), "Food & Clothing", null },
                { 6, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1714), null, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1714), "Housing & Utilities", null },
                { 7, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1715), null, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1715), "Transportation", null },
                { 8, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1764), null, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(1765), "Gifts & Donations", null }
            });
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                { 1, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(2962), null, "Index funds track the performance of a particular market index; great diversification, low fees, and easy management.", new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(2963), "Index fund (default)", null, 8.1m, 15.2m, 2 },
                { 2, new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(2972), null, "Bond funds provide great diversification potential and are stereotypically less volatile than other securities.", new DateTime(2023, 3, 5, 15, 58, 11, 440, DateTimeKind.Utc).AddTicks(2972), "Bond fund (default)", null, 1.9m, 3.0m, 5 }
            });
